<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            <h3 class="h-font fw-bold fs-3 mb-2">{{ $setting->site_title }}</h3>
            <p>
                {{ $setting->site_about }}
            </p>
        </div>
        <div class="col-lg-4 p-4">
            ...
            <a href="{{ route('home.index') }}" class="d-inline-block mb-2 text-dark text-decoration-none">Trang Chủ</a>
            <br>
            <a href="{{ route('rooms.index') }}" class="d-inline-block mb-2 text-dark text-decoration-none">Phòng</a> <br>
            <a href="{{ route('home.facilities') }}" class="d-inline-block mb-2 text-dark text-decoration-none">Tiện
                Nghi</a> <br>
            <a href="{{ route('home.contact') }}" class="d-inline-block mb-2 text-dark text-decoration-none">Liên Hệ</a>
            <br>
            <a href="{{ route('home.about') }}" class="d-inline-block mb-2 text-dark text-decoration-none">Giới
                Thiệu</a>
        </div>
        <div class="col-lg-4 p-4">
            ...
            @if (!empty($setting->tw))
                <a href="{{ $setting->tw }}" class="d-inline-block text-dark text-decoration-none mb-2">
                    <i class="bi bi-twitter me-1"></i> Twitter
                </a><br>
            @endif

            <a href="{{ $setting->fb }}" class="d-inline-block text-dark text-decoration-none mb-2">
                <i class="bi bi-facebook me-1"></i> Facebook
            </a><br>
            <a href="{{ $setting->insta }}" class="d-inline-block text-dark text-decoration-none">
...
<script>
    ...
    login_form.addEventListener('submit', (e) => {
        ...
        let xhr = new XMLHttpRequest();
        xhr.open("POST", "{{ route('ajax.login') }}", true);
    ...
    function checkLoginToBook(status, room_id) {
        if (status) {
            window.location.href = `{{ route('booking.confirm', ['id' => 'paramsid']) }}`.replace('paramsid', room_id);
        } else {
